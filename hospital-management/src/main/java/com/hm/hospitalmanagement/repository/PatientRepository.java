...
import com.hm.hospitalmanagement.dto.BloodGroupCountResponseEntity;
...
public interface PatientRepository extends JpaRepository<Patient, Long> {
    ...
    @Query("select new com.hm.hospitalmanagement.dto.BloodGroupCountResponseEntity(p.bloodGroup," +
